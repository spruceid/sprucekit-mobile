...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    }    else if (value is Oid4vpCompatibilityMode) {
      buffer.putUint8(129);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        ...
        return value == null ? null : Oid4vpCompatibilityMode.values[value];
      case 130:
...
class Oid4vp {
  ...
  Future<HandleAuthRequestResult> handleAuthorizationRequest(String url, Oid4vpCompatibilityMode mode) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[url, mode]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
