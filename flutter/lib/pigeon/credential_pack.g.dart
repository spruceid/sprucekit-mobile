...
class ParsedCredentialData {
  ...
  static ParsedCredentialData decode(Object result) {
    ...
    return ParsedCredentialData(
      ...
      doctype: result[3] as String?,
      vct: result[4] as String?,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(id, other.id) && _deepEquals(format, other.format) && _deepEquals(rawCredential, other.rawCredential) && _deepEquals(doctype, other.doctype) && _deepEquals(vct, other.vct);
  }
...
class ParsedCredentialPreview {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(format, other.format) && _deepEquals(doctype, other.doctype) && _deepEquals(vct, other.vct) && _deepEquals(claimsJson, other.claimsJson);
  }
...
class CredentialPack {
  ...
  Future<Map<String, CredentialStatus>> getStatusLists(String packId, bool hasConnection) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.sprucekit_mobile.CredentialPack.getStatusLists$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[packId, hasConnection]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    ...
    ;
    return (pigeonVar_replyValue! as Map<Object?, Object?>).cast<String, CredentialStatus>();
  }
