...
struct ParsedCredentialData: Hashable {
  ...
  static func == (lhs: ParsedCredentialData, rhs: ParsedCredentialData) -> Bool {
    ...
    return deepEqualsCredentialPack(lhs.id, rhs.id) && deepEqualsCredentialPack(lhs.format, rhs.format) && deepEqualsCredentialPack(lhs.rawCredential, rhs.rawCredential)
  }
