...
protocol Oid4vp {
  ...
  func createHolder(credentialPackIds: [String], trustedDids: [String], keyMap: [String: String], fallbackKeyId: String, contextMap: [String: String]?, completion: @escaping (Result<Oid4vpResult, Error>) -> Void)
