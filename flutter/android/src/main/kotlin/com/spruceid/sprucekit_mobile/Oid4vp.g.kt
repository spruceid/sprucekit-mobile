...
) : Oid4vpResult()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): Oid4vpSuccess {
      ...
      return Oid4vpSuccess(message, redirectUrl)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return Oid4vpPigeonUtils.deepEquals(this.message, other.message) && Oid4vpPigeonUtils.deepEquals(this.redirectUrl, other.redirectUrl)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + Oid4vpPigeonUtils.deepHash(this.message)
    result = 31 * result + Oid4vpPigeonUtils.deepHash(this.redirectUrl)
    return result
  }
}
