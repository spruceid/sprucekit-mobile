...
data class ParsedCredentialData (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return CredentialPackPigeonUtils.deepEquals(this.id, other.id) && CredentialPackPigeonUtils.deepEquals(this.format, other.format) && CredentialPackPigeonUtils.deepEquals(this.rawCredential, other.rawCredential)
  }
